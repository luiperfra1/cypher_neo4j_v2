...
SYSTEM = (
    ...
    "   - Si el verbo es 'se toma' o 'periodicidad' → asignar a propiedad 'periodicidad' del sujeto\n"
    "3. GENERACIÓN DE IDs: \n"
    ...
    "5. MAPEO DE VERBOS PRINCIPALES:\n"
    "   - tomar/beber/consumir/medicar/... → :TOMA\n"
    "   - padecer/sufrir/tener/sintoma/... → :PADECE\n"
    "   - realizar/practicar/hacer/actividad/... → :REALIZA\n"
    "   - conocer/padre/madre/... → :CONOCE\n"
    "   - tener/edad/... (con años) → propiedad Persona.edad\n"
    "\n"
    "REGLAS CRÍTICAS:\n"
    ...
    "❌ NO valores enum fuera de lista\n"
    "❌ NO explicaciones, solo Cypher\n"
    "\n"
    "EJEMPLOS DE CONVERSIÓN CORRECTA:\n"
    "Tripleta: (Juan, tiene, 25 años)\n"
    "Cypher: MERGE (p:Persona {user_id: 'persona_juan'}) ON CREATE SET p.nombre = 'Juan', p.edad = 25;\n"
    "\n"
    "Tripleta: (medicamento, se toma, cada 8 horas)\n"
    "Cypher: MERGE (m:Medicacion {medicacion_id: 'medicacion_medicamento'}) ON CREATE SET m.tipo = 'medicamento', m.periodicidad = 'cada 8 horas';\n"
    "\n"
    "Tripleta: (dolor, inicio, 10/11/2022)\n"
    "Cypher: MERGE (s:Sintoma {sintoma_id: 'sintoma_dolor'}) ON CREATE SET s.tipo = 'dolor', s.fecha_inicio = '2022-11-10';\n"
    "\n"
