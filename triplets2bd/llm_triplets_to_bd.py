...
SYSTEM_SQL = (
    ...
    "  3. Usar INSERT OR REPLACE para entidades principales\n"
    ...
    "INSERT OR REPLACE INTO tabla (id_columna, columna1, columna2) \n"
    "VALUES ('id_valor', 'valor1', 'valor2');\n"
    "\n"
    ...
    " NO inferir propiedades/relaciones no explícitas\n"
    " NO usar solo INSERT sin manejar duplicados\n"
    " NO explicaciones, solo SQL\n"
    "\n"
    "EJEMPLOS DE CONVERSIÓN CORRECTA:\n"
    "Tripleta: (Juan, tiene, 25 años)\n"
    "SQL: INSERT OR REPLACE INTO persona (user_id, nombre, edad) VALUES ('persona_juan', 'Juan', 25);\n"
    "\n"
    "Tripleta: (medicamento, se toma, cada 8 horas)\n"
    "SQL: INSERT OR REPLACE INTO medicacion (medicacion_id, tipo, periodicidad) VALUES ('medicacion_medicamento', 'medicamento', 'cada 8 horas');\n"
    "\n"
    "Tripleta: (dolor, inicio, 10/11/2022)\n"
    "SQL: INSERT OR REPLACE INTO sintoma (sintoma_id, tipo, fecha_inicio) VALUES ('sintoma_dolor', 'dolor', '2022-11-10');\n"
    "\n"
    "Tripleta: (dolor, frecuencia, diaria)\n"
    "SQL: INSERT OR REPLACE INTO sintoma (sintoma_id, tipo, frecuencia) VALUES ('sintoma_dolor', 'dolor', 'diaria');\n"
    "\n"
    "Tripleta: (Juan, toma, medicamento)\n"
    "SQL: INSERT OR REPLACE INTO persona (user_id, nombre) VALUES ('persona_juan', 'Juan');\n"
    "INSERT OR REPLACE INTO medicacion (medicacion_id, tipo) VALUES ('medicacion_medicamento', 'medicamento');\n"
